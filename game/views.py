    ...
    if request.method == 'POST':
        ...
        polygon = Feature(geometry=MultiPolygon(
            [([(lat + 1, lon + 1), (lat - 1, lon - 1), (lat - 1, lon + 1), (lat + 1, lon - 1)],),
             ...
             (
             [(50.7364445, -3.5293083), (50.7358839, -3.5291410), (50.7360017, -3.5298109), (50.7363348, -3.5299208)],),
             (
             [(50.7287101, -3.5374679), (50.7280259, -3.5364497), (50.7280361, -3.5353282), (50.7289626, -3.5356284)],),
